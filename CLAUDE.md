...
`specs/001-cli-ingest-client/plan.md` and its companion artifacts:

- `specs/001-cli-ingest-client/spec.md` — feature spec (authoritative)
- `specs/001-cli-ingest-client/research.md` — locked implementation decisions
- `specs/001-cli-ingest-client/data-model.md` — internal entity shapes

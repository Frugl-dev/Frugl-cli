...
| `71` | `ALREADY_IN_OTHER_ORG`  | One-org-per-user conflict: the caller is already a Member of a *different* Organization (`409 wrong_org`). Message names the current and target orgs from `details`. | FR-018; US3 |
